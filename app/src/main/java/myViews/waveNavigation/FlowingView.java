package myViews.waveNavigation;
...
import com.mxn.soul.flowingdrawer_core.FlowingAnimationListener;
...
public class FlowingView extends View {
    ...
    private void init() {
        ...
        mPaint.setColor(getResources().getColor(com.mxn.soul.flowingdrawer_core.R.color.paint_color));
    }
    ...
    public void downing() {
        ...
        ValueAnimator valueAnimator = ValueAnimator.ofInt(w + 80, w - rightMargin);
